...
export const Snowflake: React.FC<{ delay: number }> = ({ delay }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <path
            d="M12 2L12 22M2 12L22 12M5.5 5.5L18.5 18.5M5.5 18.5L18.5 5.5M12 2L9 5L12 8M12 22L9 19L12 16M12 2L15 5L12 8M12 22L15 19L12 16M2 12L5 9L8 12M22 12L19 9L16 12M2 12L5 15L8 12M22 12L19 15L16 12"
            stroke="white"
            strokeWidth="1"
            fill="none"
            strokeLinecap="round"
